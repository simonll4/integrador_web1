...
public class GenerarEjemplosDePlanes {
        ...
        public static List<Plan> generar(int cantidadAGenerar, boolean imprimirResultado) {
                ...
                quinto.getMaterias().add(new MateriaImpl(quinto, codigoVerificacion++, codigoMateria,
                                "Lengua y Literatura Castellana V", 4.0));
                quinto.getMaterias().add(
                                new MateriaImpl(quinto, codigoVerificacion++, codigoMateria, "Materia Optativa", 3.0));
                quinto.getMaterias().add(new MateriaImpl(quinto, codigoVerificacion++, codigoMateria,
                                "Lengua y Culturas Griegas", 3.0));
                quinto.getMaterias().add(new MateriaImpl(quinto, codigoVerificacion++, codigoMateria,
                                "Lengua y Cultura Inglesas V", 3.0));
                quinto.getMaterias()
                ...
                primero2014.getMaterias().add(
                                new MateriaImpl(primero2014, codigoVerificacion++, codigoMateria, "Ingles I",
                                                3.0));
                primero2014.getMaterias().add(
                                new MateriaImpl(primero2014, codigoVerificacion++, codigoMateria,
                                                "Geografia I", 3.0));
                primero2014.getMaterias().add(
                                new MateriaImpl(primero2014, codigoVerificacion++, codigoMateria,
                                                "Historia I", 2.0));
                ...
                primero2014.getMaterias().add(
                                new MateriaImpl(primero2014, codigoVerificacion++, codigoMateria,
                                                "Plastica I", 2.0));
                primero2014.getMaterias().add(
                                new MateriaImpl(primero2014, codigoVerificacion++, codigoMateria, "Musica I",
                                                2.0));
                primero2014.getMaterias()
                                .add(new MateriaImpl(primero2014, codigoVerificacion++, codigoMateria,
                                                "Ciencias Naturales I", 3.0));
                primero2014.getMaterias().add(new MateriaImpl(primero2014,
                                codigoVerificacion++, codigoMateria,
                                "Tecnicas de Trabajo Intelectual I", 2.0));
                primero2014.getMaterias().add(new MateriaImpl(primero2014,
                                codigoVerificacion++, codigoMateria,
                                "Informatica I", 2.0));
                ...
                segundo2014.getMaterias()
                                .add(new MateriaImpl(segundo2014, codigoVerificacion++, codigoMateria,
                                                "Formación Ética y Ciudadana II", 3.0));
                segundo2014.getMaterias().add(new MateriaImpl(segundo2014,
                                codigoVerificacion++, codigoMateria,
                                "Geografía II", 3.0));
                segundo2014.getMaterias().add(
                                new MateriaImpl(segundo2014, codigoVerificacion++, codigoMateria,
                                                "Historia II", 3.0));
                segundo2014.getMaterias().add(new MateriaImpl(segundo2014,
                                codigoVerificacion++, codigoMateria,
                                "Matemática II ", 4.0));
                ...
                tercero2014.getMaterias().add(
                                new MateriaImpl(tercero2014, codigoVerificacion++, codigoMateria,
                                                "Ingles III", 3.0));
                tercero2014.getMaterias()
                                .add(new MateriaImpl(tercero2014, codigoVerificacion++, codigoMateria,
                                                "Formacion Etica y Civica II", 2.0));
                tercero2014.getMaterias().add(new MateriaImpl(tercero2014,
                                codigoVerificacion++, codigoMateria,
                                "Geografía III", 3.0));
                tercero2014.getMaterias().add(
                                new MateriaImpl(tercero2014, codigoVerificacion++, codigoMateria,
                ...
                cuarto2014.getMaterias().add(
                                new MateriaImpl(cuarto2014, codigoVerificacion++, codigoMateria,
                                                "Lengua y Literatura Castellanas IV", 4.0));
                cuarto2014.getMaterias().add(new MateriaImpl(cuarto2014,
                                codigoVerificacion++, codigoMateria,
                                "Lengua y Cultura Latinas IV", 4.0));
                cuarto2014.getMaterias().add(new MateriaImpl(cuarto2014,
                                codigoVerificacion++, codigoMateria,
                ...
                quinto2014.getMaterias().add(
                                new MateriaImpl(quinto2014, codigoVerificacion++, codigoMateria, "Frances I",
                                                3.0));
                quinto2014.getMaterias().add(
                                new MateriaImpl(quinto2014, codigoVerificacion++, codigoMateria,
                                                "Geografía V", 3.0));
                quinto2014.getMaterias().add(
                                new MateriaImpl(quinto2014, codigoVerificacion++, codigoMateria,
                                                "Historia V", 4.0));
                quinto2014.getMaterias().add(
                                new MateriaImpl(quinto2014, codigoVerificacion++, codigoMateria, "Quimica I",
                                                2.0));
                quinto2014.getMaterias().add(
                                new MateriaImpl(quinto2014, codigoVerificacion++, codigoMateria,
                                                "Biologia II", 2.0));
                ...
                quinto2014.getMaterias()
                                .add(new MateriaImpl(quinto2014, codigoVerificacion++, codigoMateria,
                                                "Estadistica y Probabilidades", 3.0));
                quinto2014.getMaterias().add(new MateriaImpl(quinto2014,
                                codigoVerificacion++, codigoMateria,
                                "Educacion Fisica V", 2.0));
                quinto2014.getMaterias().add(new MateriaImpl(quinto2014,
                                codigoVerificacion++, codigoMateria,
