package ingweb.Integrador.Colegio.Ar.edu.aui.util;
...
import ingweb.Integrador.Colegio.Ar.edu.aui.persist.*;
...
public class Poblator {
        ...
        private String[] code2 = { "AR", "AR", "AR", "AR", "AR", "AR", "AR", "AR", "AR", "AR", "AR", "BR", "BO", "CL",
                        "CO", "GY", "PE", null };
        ...
        private String[] neighborhood = { "Las Palmas", "Quilmes", "Guemes", "Pueyrredon", "Los Olmos",
                        ...
                        "Parque Las Pradas", "Parque America", "Villavicencio", "Las Pradas 1", "Las Pradas 2",
                        "Newells",
        ...
        private String[] namesLocations = { "Capital", "Capital Federal", "Unquillo", "Sarmiento", "Roca",
                        "Agua de Plata", "Alejo Gacela", "Alma Debil", "Marito Juarez", "Bouwer", "Mialet Basse",
                        "Vell Bille",
                        "Balnearios", "Tercero Abajo", "Unidos", "Rio Septimo", "San Injusto", "Rio Blanco",
                        "Calamuchito",
                        "Roque Penia", "Ferrari", "Luther King" };

        // Person
        private String[] id = { "47782444", "47495523", "47554715", "69531161", "46275063", "76874464",
                        "85357399Y", "71836034L", "75324014A", "74115380L", "16988532L", "32369962S", "34037170E",
                        "22920980P",
                        "20851837Z", "55192555F", "31768382T", "13944350W", "46829254N", "54059316R", "14061055M",
                        "72781211B" };

        private String[] name = { "Alberto", "Ana", "Benjamin", "Brenda", "Carlos", "Carmen", "Dylan", "Delfina",
                        "Elias", "Eliana", "Federico", "Fernanda", "German", "Gabriel", "Hernan", "Heliana", "Ismael",
                        "Irina",
                        "Jorge", "Juliana", "Kilian", "Karmen", "Lionel", "Lucila", "Matias", "Micaela", "Nahuel",
                        "Natalia",
                        "Osvaldo", "Oriana", "Pablo", "Paola", "Quinto", "Quetzal", "Raul", "Rocio", "Simon", "Sabrina",
                        "Tadeo", "Taehyung", "Uriel", "Ulda", "Valentin", "Viviana", "Walter", "Wanda", "Xavi",
                        "Ximena",
                        "Yoshua", "Yessica", "Zacarias", "Zara" };

        private String[] lastName = { "Carrizo", "Rodriguez", "Otamendi", "Messi", "Gates", "Musk",
                        "Luna", "Villalba", "Llamosas", "Besos", "De La Serna", "De La Fuente", "De Armas",
                        "Guillaumet",
        ...
        private String[] dateBirth = { "05/10/2001", "25/11/2012", "12/04/2011", "13/03/2008", "05/10/2001",
                        "04/07/2008", "02/01/2009", "17/06/2010", "26/12/2012", "31/09/2014", "28/02/2015",
                        "14/01/2012", "08/07/201", "20/09/2006", "18/01/2003", "11/01/04", "25/09/94", "15/04/2007",
                        "25/03/2008", "20/06/1975", "14/01/2012", "25/07/1983", "29/03/1979", "19/08/1980",
                        "05/10/1985" };
        ...
        private String[] email = { "masitas12", "bananas2", "emailrandom", "claro3", "talleresmivida4",
                        "yc23vub", "lwenhgiuo2", "caviar5", "condor9", "vivaperon15", "menem7", "maildemessi",
                        "billgates", "rtj4",
                        "wiufehu1", "bastadecastear", "ojebf99", "lolaso12", "iu34ty2i", "vegeta777", "microhard",
                        "a32" };

        private String[] phone = { "3545768561 ", "3510100710", "3212991844 ", "3654181123", "3510955567",
                        "3237875974", "3717335875", "3589331667", "3316312998", "3117527369", "3516226468",
                        "3222728590",
                        "3510674431", "3569673029", "3894238816", "3278894893", "3116021441", "3576871168",
                        "3998146207", null,
        ...
        public List<Home> buildRandomHome(int count) {
                ...
                for (int ii = 0; ii < count; ii++) {
                        ...
                        aux.setLatitude(Math.random() * 20 + (-80));
                        aux.setLongitude(Math.random() * (-10) + 104);
                        homeList.add(aux);
                }
                return homeList;
        }
